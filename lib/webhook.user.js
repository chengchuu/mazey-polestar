...
function extractMessageBody(contentElement) {
  ...
  clone.querySelectorAll(".message-signature, .message-views, .message-media-duration, " +
  //  .message-time, [data-ignore-on-paste=\"true\"] .MessageMeta,
  ".icon-channelviews, .Reactions").forEach(function (metadataElement) {

...
function findRelatedMessageTimeElement(contentElement, containerElement) {
  ...
  var scopeElement = contentElement;
  while (scopeElement && scopeElement !== document) {
    var messageTimeElement = findMessageTimeElementInScope(scopeElement);
  ...
  return findMessageTimeElementInScope(messageRoot) || findMessageTimeElementInScope(containerElement);
}

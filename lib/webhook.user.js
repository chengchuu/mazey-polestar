...
function setRunningFavicon() {
  var faviconElement = findFaviconElement();
  var created = !faviconElement;
  if (!faviconElement) {
...
function restoreFavicon() {
  ...
  var _state$originalFavico = state.originalFavicon,
    element = _state$originalFavico.element,
    created = _state$originalFavico.created,
    rel = _state$originalFavico.rel,
    href = _state$originalFavico.href,
    type = _state$originalFavico.type,
    sizes = _state$originalFavico.sizes;
  if (created) {
    element.remove();
  } else {
